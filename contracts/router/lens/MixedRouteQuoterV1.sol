...
import '../../v3/core/interfaces/ILaminarV3Pool.sol';
import '../../v3/core/interfaces/callback/ILaminarV3SwapCallback.sol';
...
import '../../v2/core/interfaces/ILaminarV2Pair.sol';

import '../base/ImmutableState.sol';
import '../interfaces/IMixedRouteQuoterV1.sol';
import '../libraries/PoolTicksCounter.sol';
import '../libraries/LaminarV2Library.sol';
...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, ILaminarV3SwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for ILaminarV3Pool;
    ...
    constructor(
        ...
        address _factoryV2,
        address _WHYPE
    ) PeripheryImmutableState(_factory, _WHYPE) {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (ILaminarV3Pool) {
        return ILaminarV3Pool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }
    ...
    function getPairAmountOut(
        ...
        (uint256 reserveIn, uint256 reserveOut) = LaminarV2Library.getReserves(factoryV2, tokenIn, tokenOut);
        return LaminarV2Library.getAmountOut(amountIn, reserveIn, reserveOut);
    }

    /// @inheritdoc ILaminarV3SwapCallback
    function laminarV3SwapCallback(
        ...
        ILaminarV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        ILaminarV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
