...
contract QuoterV2 is IQuoterV2, ILaminarV3SwapCallback, PeripheryImmutableState {
    ...
    constructor(address _factory, address _WHYPE) PeripheryImmutableState(_factory, _WHYPE) {}
